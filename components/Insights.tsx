  ...
  const featured = [
    {
      ...
      category: "TOP POTENTIAL",
      match: "98%",
      image: "https://img.freepik.com/free-vector/little-boy-playing-xylophone_1308-161671.jpg?t=st=1734538000~exp=1734541600~hmac=000000",
      color: "from-teal-500/20 to-teal-900/80"
    },
    {
      id: 2,
      title: "Is your child a sprinter or marathoner?",
      category: "PHYSICAL DESIGN",
      match: "ACTN3 CC",
      image: "https://images.unsplash.com/photo-1517836357463-d25dfeac3438?q=80&w=800&auto=format&fit=crop", // Running/Outdoors
      color: "from-yellow-500/20 to-yellow-900/80"
    }
  ];
  ...
  const articles = [
    {
      ...
      tag: "#INTELLIGENCE",
      readTime: "3 MIN READ",
      title: "Cognitive Flex: The DNA behind problem-solving",
      desc: "Discover the genetic markers linked to logical reasoning and...",
      image: "https://images.unsplash.com/photo-1530026405186-ed1f139313f8?q=80&w=400&auto=format&fit=crop" // DNA Helix
    },
    {
      id: 2,
      tag: "#MUSIC",
      readTime: "5 MIN READ",
      title: "Perfect Pitch: Genetic markers in melody",
      desc: "Does your child have a natural inclination for harmony? Learn...",
      image: "https://images.unsplash.com/photo-1514119412350-e174d90d280e?q=80&w=400&auto=format&fit=crop" // Violin
    },
    {
      id: 3,
      tag: "#SPORTS",
      readTime: "4 MIN READ",
      title: "Muscle Fiber Type & Sport Selection",
      desc: "Matching your child's physical traits with the right athletic...",
      image: "https://images.unsplash.com/photo-1552674605-5d226a5be999?q=80&w=400&auto=format&fit=crop" // Running illustration
    }
  ];
                    ...
                    >
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                            <span className={`text-[10px] font-bold uppercase tracking-widest mb-2 inline-block ${
                                item.category.includes('POTENTIAL') ? 'text-teal-300' : 'text-yellow-300'
                            }`}>
                                {item.category}
                            </span>
