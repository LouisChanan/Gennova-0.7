                ...
                <div className="flex relative z-10">
                    <div className="p-5 flex-1">
                        ...
                        <p className="text-xs text-slate-500 font-medium leading-relaxed mb-4 max-w-[160px]">
                            Discover your child's cognitive potential through their latest DNA sequence analysis.
                        </p>

                        <button className="bg-teal-400 hover:bg-teal-500 text-white px-5 py-2.5 rounded-full text-sm font-bold shadow-lg shadow-teal-100 transition-all active:scale-95 flex items-center">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-slate-500 mt-0.5 leading-tight max-w-[180px]">
                            Time to complete today's genetic development activity for Leo.
                        </p>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-[28px] p-5 shadow-sm border border-gray-50 flex items-center justify-between group cursor-pointer hover:shadow-md transition-shadow">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-500 mt-0.5 max-w-[180px] truncate">
                                Review Leo's progress in cognitive sk...
                            </p>
                        </div>
                    </div>
