...
export const LinkKitFlow: React.FC<LinkKitFlowProps> = ({ onClose, onComplete }) => {
    ...
    const handleRegisterSubmit = async () => {
        ...
        try {
            ...
            console.error('Error linking kit:', err);
            alert('Failed to link kit. Please try again.');
        } finally {
            setLoading(false);
        }
    };
                ...
                <div className="min-h-screen flex flex-col bg-gray-50/50">
                    ...
                    <div className="flex-1 px-6 space-y-6 pb-24 overflow-y-auto">
                        ...
                        <div>
                            ...
                            <div className="bg-white border border-gray-100 rounded-2xl p-4 flex justify-between items-center shadow-sm relative">
                                <input
                                    type="date"
                                    value={dob}
                                ...
                                />
                                <Calendar size={20} className="text-gray-400 absolute right-4 pointer-events-none" />
                            </div>
                        </div>
                        ...
                        <div className="w-full bg-white rounded-3xl p-3 flex items-center space-x-4 shadow-lg shadow-teal-50 border border-teal-50 mb-8">
                            ...
                            <div className="text-left flex-1">
                                <div className="flex items-center">
                                    <h3 className="font-bold text-slate-900 text-lg">{profileName || 'Individual'}'s Profile</h3>
                                </div>
                                <div className="inline-flex items-center space-x-1 bg-teal-50 text-teal-500 px-2 py-0.5 rounded-md mt-1">
                                    ...
                                    <span className="text-[10px] font-bold tracking-wide">#{kitId}</span>
                                </div>
                            </div>
